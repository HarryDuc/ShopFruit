      ...
      <div class="mt-7 bg-white border border-gray-200 rounded-xl shadow-sm dark:bg-gray-800 dark:border-gray-700">
        <div class="p-4 sm:p-7">
          <div class="text-center">
            <h1 class="block text-2xl font-bold text-gray-800 dark:text-white">Thay đổi mật khẩu</h1>
          </div>
          ...
          <div class="mt-5">
            ...
            <form wire:submit.prevent='save'>
              ...
              <div class="grid gap-y-4">
                ...
                <div>
                  <label for="password_confirmation" class="block text-sm mb-2 dark:text-white">Xác nhận mật khẩu</label>
                  <div class="relative">
