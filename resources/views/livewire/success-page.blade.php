    ...
    <div
      ...
      <div>
        <h1 class="px-4 mb-8 text-2xl font-semibold tracking-wide text-gray-700 dark:text-gray-300 ">
          Cảm ơn. Hóa đơn của bạn đã được gửi. </h1>
        <div
            ...
            <div class="flex items-center justify-center w-full pb-6 space-x-4 md:justify-start">
              <div class="flex flex-col items-start justify-start space-y-2">
                ...
                <p class="text-sm leading-4 text-gray-600 dark:text-gray-400">
                  {{$order->address->state}}, {{$order->address->city}}, {{$order->address->postal_code}}
                </p>
        ...
        <div class="flex flex-wrap items-center pb-4 mb-10 border-b border-gray-200 dark:border-gray-700">
          ...
          <div class="w-full px-4 mb-4 md:w-1/4">
            ...
            <p class="text-base font-semibold leading-4 text-gray-800 dark:text-gray-400 ">
              {{$order->payment_method == 'cod' ? "COD" : "Card"}}</p>
          </div>
        </div>
        <div class="px-4 mb-10">
          <div
            ...
            <div class="flex flex-col w-full space-y-6 ">
              <h2 class="mb-2 text-xl font-semibold text-gray-700 dark:text-gray-400">Chi tiết hóa đơn</h2>
              <div
                ...
                <div class="flex justify-between w-full">
                  <p class="text-base leading-4 text-gray-800 dark:text-gray-400">Tổng hóa đơn</p>
                  <p class="text-base leading-4 text-gray-600 dark:text-gray-400">{{number_format($order->grand_total, 0,  ',' , '.')}}₫</p>
                </div>
                <div class="flex items-center justify-between w-full">
                  <p class="text-base leading-4 text-gray-800 dark:text-gray-400">Giảm giá
                  </p>
                  <p class="text-base leading-4 text-gray-600 dark:text-gray-400">0₫</p>
                </div>
                <div class="flex items-center justify-between w-full">
                  <p class="text-base leading-4 text-gray-800 dark:text-gray-400">Phí vận chuyển</p>
                  <p class="text-base leading-4 text-gray-600 dark:text-gray-400">0₫</p>
                </div>
              </div>
              <div class="flex items-center justify-between w-full">
                <p class="text-base font-semibold leading-4 text-gray-800 dark:text-gray-400">Tổng</p>
                <p class="text-base font-semibold leading-4 text-gray-600 dark:text-gray-400">{{number_format($order->grand_total, 0,  ',' , '.')}}₫</p>
              </div>
            </div>
            <div class="flex flex-col w-full px-2 space-y-4 md:px-8 ">
              <h2 class="mb-2 text-xl font-semibold text-gray-700 dark:text-gray-400">Vận chuyển</h2>
                ...
                <div class="flex items-center justify-center space-x-2">
                  ...
                  <div class="flex flex-col items-center justify-start">
                    <p class="text-lg font-semibold leading-6 text-gray-800 dark:text-gray-400">
                      Vận chuyển<br><span class="text-sm font-normal">Giao hàng trong 24 giờ.</span>
                    </p>
                  </div>
                </div>
