      ...
      <div class="flex flex-wrap mb-24 -mx-3">
        <div class="w-full pr-2 lg:w-1/4 lg:block">
          <div class="p-4 mb-5 bg-white border border-gray-200 dark:border-gray-900 dark:bg-gray-900">
            ...
            <ul>
              ...
              <li class="mb-4" wire:key="{{$category->id}}">
                <label for="{{$category->slug}}" id="{{$category->slug}}" value="{{$category->id}}" class="flex items-center dark:text-gray-400 ">
          ...
          <div class="p-4 mb-5 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-900">
            ...
            <div class="w-16 pb-2 mb-6 border-b border-rose-600 dark:border-gray-400"></div>
            <div>
              <input type="range" class="w-full h-1 mb-4 bg-blue-100 rounded appearance-none cursor-pointer" max="5000000" value="100000" step="100000">
              <div class="flex justify-between ">
                <span class="inline-block text-lg font-bold text-blue-400 ">10000đ</span>
                <span class="inline-block text-lg font-bold text-blue-400 ">5000000đ</span>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="w-full px-3 mb-6 sm:w-1/2 md:w-1/3" wire:key="{{$product->id}}">
              <div class="border border-gray-300 dark:border-gray-700">
                ...
                <div class="p-3 ">
                  ...
                  <p class="text-lg ">
                    <span class="text-green-600 dark:text-green-600">{{Number::currency($product->price, 'VND')}}</span>
                  </p>
                </div>
